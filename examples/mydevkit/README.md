...
That target packs this example, installs it in [consumer](consumer), extracts the composed XDR
tree, verifies the generated skill symlink, and lints the resulting workspace.
